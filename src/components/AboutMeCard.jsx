export function AboutMeCard() {
	const imgUrl = 'https://source.unsplash.com/MP0IUfwrn0A';
	return (
		<>
			<div className='max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 '>
				...
				>
					<div className='p-4 md:p-12 text-center lg:text-left'>
						...
						<h1 className='text-white text-3xl font-bold pt-8 lg:pt-0'>
							Carla Ortiz
						</h1>
						...
						<p className='pt-2 text-white text-xs lg:text-sm flex items-center justify-center lg:justify-start'>
							...
							Classroom Teacher 10+ years experience
						</p>
						<p className='pt-8 text-sm text-white'>
							I was born in Tlalnepantla, MX. I have many years of teaching
							experience including having won teacher of the year award.
						</p>

						<div className='pt-12 pb-8'>
							<button className='text-white bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full'>
								Get In Touch
							</button>
						</div>
